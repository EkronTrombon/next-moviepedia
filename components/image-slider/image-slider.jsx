  ...
  return (
    <>
      <div className="relative w-full md:max-w-4xl md:mx-auto">
        ...
        {/* Modal */}
        <Dialog id="selected-actor">
          {selectedImage && (
            <>
              <div className="flex justify-between items-center p-4 border-b border-black">
                <h3 className="text-black text-3xl font-bold">{selectedImage.name}</h3>
                <button commandfor="selected-actor" command="close" className="text-black hover:rotate-90 transition-transform duration-300 focus:outline-none" aria-label="Close modal">
